...
public class CanalController {
    ...
    /**
     * 1、构建PlainCanalConfigClient，用于用户远程配置的获取
     ...
     * 6、初始化InstanceAction，完成monitor机制。（监控instance配置变化然后调用ServerRunningMonitor进行处理）
     * @param properties
     */
     ...
     * 2、先启动embededCanalServer（会启动对应的监控）
     * 3、根据配置的instance的destination，调用runningMonitor.start() 逐个启动instance
